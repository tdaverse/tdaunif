...
#'   specific parametrization was taken from (insert). The uniform sample is
...
#' @rdname arch-spirals
#' @export
sample_arch_spiral <- function(n, min_wrap = 0, max_wrap = 1){
