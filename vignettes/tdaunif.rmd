...
For a quick surface validation, we can compare our custom rejection sampler to the volume-preserving parameterization--based disc sampler provided by **tdaunif**:

```{r, fig.width=6, fig.height=4}
disc2 <- sample_disc(360L)
par(mfrow = c(1L, 2L))
plot(disc1, asp = 1, pch = 19, cex = 1/3)
plot(disc2, asp = 1, pch = 19, cex = 1/3)
par(mfrow = c(1L, 1L))
```
